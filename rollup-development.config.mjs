...
const nodeEsm = {
  output: [
    {
      file: "demo/browser/dist/liquid.node.esm.js",
      format: "esm",
      banner,
    },
  ],
  external: ["path", "fs", "stream"],
  plugins: [versionInjection, replace(esmRequire), typescript(tsconfig("es6"))],
  treeshake,
  input,
};
...
const browserEsm = {
  output: [
    {
      file: "demo/browser/dist/liquid.browser.esm.js",
      format: "esm",
      banner,
    },
  ],
...
const browserUmd = {
  output: [
    {
      file: "demo/browser/dist/liquid.browser.umd.js",
      name: "liquidjs",
      format: "umd",
      sourcemap,
      banner,
...
const browserMin = {
  output: [
    {
      file: "demo/browser/dist/liquid.browser.min.js",
      name: "liquidjs",
      format: "umd",
      sourcemap,
      banner,
...
if (bundles.length === 0)
  bundles.push(nodeCjs, nodeEsm, browserEsm, browserUmd, browserMin);
